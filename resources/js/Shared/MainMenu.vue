<template>
  <div>
    ...
    <div v-can="'role-list'" class="mb-4">
    ...
    <div v-can="'permission-list'" class="mb-4">
      <inertia-link class="flex items-center group py-3" :href="route('permissions')">
        <icon name="dashboard" class="w-4 h-4 mr-2" :class="isUrl('') ? 'fill-white' : 'fill-indigo-light group-hover:fill-white'" />
        <div :class="isUrl('') ? 'text-white' : 'text-indigo-lighter group-hover:text-white'">Permissions</div>
      </inertia-link>
    </div>
    <div class="mb-4">
